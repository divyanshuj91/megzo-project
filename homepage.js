...
function checkLoginStatus() {
    ...
    if (user && loginBtn) {
        // Change button to look like a profile link
        loginBtn.innerHTML = `
...
function loadProducts() {
    ...
    const products = [
        { title: " Headphones", price: 2999, img: "images/wheadphones.png" },
        { title: "Smart Watch ", price: 4500, img: "images/smartwatch.png" },
        { title: " Laptop", price: 55000, img: "images/laptop.png" },
        { title: "Gaming Console", price: 35000, img: "images/gamingconsole.png" }
    ];

    grid.innerHTML = products.map((p, index) => `
        <div class="glass-card rounded-2xl p-4 flex flex-col h-full bg-white/40 fade-in cursor-pointer" 
             style="animation-delay: ${index * 100}ms"
             onclick="window.location.href='product_listing.html'">
